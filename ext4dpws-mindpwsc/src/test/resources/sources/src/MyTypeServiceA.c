...
void METH(service_a,test01)(){
	printf("serve service_a test01\n");

}

void METH(service_a,test02)(int a){

	printf("serve service_a test02\n");
